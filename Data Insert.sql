...
insert into Farms(farm_id,farmer_id,farm_name,location,farm_size) values(1,2,'AgroFarm','Chittagong',5.6);
insert into Farms(farm_id,farmer_id,farm_name,location,farm_size) values(2,3,'EasyFarm','Dinajpur',4.6);
insert into Farms(farm_id,farmer_id,farm_name,location,farm_size) values(3,1,'GreenTech','Sylhet',7.6);
insert into Farms(farm_id,farmer_id,farm_name,location,farm_size) values(4,5, 'Natural Agro Farm','Khulna',2.5);
insert into Farms(farm_id,farmer_id,farm_name,location,farm_size) values(5,4, 'Agro Biotech','Khulna',3.5);
